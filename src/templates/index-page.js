...
{/* show feature */}
{showFeature ? (   
<section id="feature" name="feature" className="print scroll-area panel" style={{  width:'100vw', minHeight:'100%', margin:'0 auto 0 auto', padding:'0 0 0 0', position:'relative',
...
{showHomePosts ? (
    <HomePosts isSliderVisible={isSliderVisible} className="scroll-area" id="posttop" name="posttop" style={{minHeight:'', width:''}} />
    ) : (
      ""
  )}
