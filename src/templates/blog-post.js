...
<ReactPlayer
        ...
        <div className="audiopopper" style={{position:'absolute', top:'-100px', right:'', zIndex:'9999', textAlign:'center', animation:'fadeIn 3s', display:'flex', justifyContent:'center', width:'auto', marginBottom:''}}>
