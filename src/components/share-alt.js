...
<div className="sharebutts" style={{   background: 'transparent',
  ...
  margin:'0 auto',}}>
   {/* Sharingbutton Facebook */}
        <a className="resp-sharing-button__link" href={`https://facebook.com/sharer/sharer.php?u={siteUrl}`} target="_blank" rel="noreferrer" aria-label="Facebook">
        ...
        <a className="resp-sharing-button__link" href={`https://twitter.com/intent/tweet/?text=Check%20out%20this%20cool%20site.&amp;url=${siteUrl}`} target="_blank" rel="noreferrer" aria-label="Twitter">
        ...
        <a className="resp-sharing-button__link" href={`https://pinterest.com/pin/create/button/?url=http%3A%2F%2Fmemegenes.com&amp;media=${siteUrl}&amp;description=Check%20out%20this%20cool%20site`} target="_blank" rel="noreferrer" aria-label="Pinterest">
        ...
        <a className="resp-sharing-button__link" href={`https://www.linkedin.com/shareArticle?mini=true&amp;url=${siteUrl}&amp;title=Check%20out%20this%20cool%20site.&amp;summary=Check%20out%20this%20cool%20site.&amp;source=${siteUrl}`} target="_blank" rel="noreferrer" aria-label="LinkedIn">
